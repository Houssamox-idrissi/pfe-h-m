  ...
  <div>
    ...
    >
      <div class="h-19">
        ...
        >
          <img
            src="./assets/stoore.png"
            class="inline h-full max-w-full transition-all duration-200 dark:hidden ease-nav-brand max-h-8"
            alt="main_logo"
          />
          <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">E-OPTIC</span>
        </router-link>
      </div>
      <hr
        ...
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            ...
            >
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Glasses</span>
            </router-link>
          </li>
          <li class="mt-0.5 w-full">
            <router-link
          ...
          <li class="mt-0.5 w-full">
            ...
            >
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Type</span>
            </router-link>
          </li>
          <li class="mt-0.5 w-full">
            <router-link
            ...
            >
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Brands</span>
            </router-link>
          </li>
        </ul>
      </div>
