<template>
   ...
   <div class="container py-16">
       <h2 class="mb-4 px-8 text-slate-600 text" style="font: 32px Minerva Modern, sans-serif;">Mens Eyeglasses</h2>
       ...
       getGlasses() {
           axios.get('http://127.0.0.1:8000/api/glasses')
               .then(res => {
                   ...
                   this.eyeglassesList = this.glassesList.filter(glasses => glasses.category.name === 'Eyeglasses' && glasses.type.name === 'Mens Eyeglasses');
               });
       },
   },
   components: {
